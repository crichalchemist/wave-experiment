...
class TestSemanticWelfareIntegration:
    ...
    def test_keyword_fallback_still_works(self):
        ...
        constructs = infer_threatened_constructs(
            "Resource allocation gap in healthcare"
        )
    ...
    def test_love_patterns_map_to_lam_L(self):
        ...
        constructs = infer_threatened_constructs(
            "Mutual aid networks build community capacity"
        )
    ...
    def test_hypothesis_welfare_scoring_with_new_constructs(self):
        ...
        assert score > 0.3  # scarce protection -> high welfare (numerical gradient)
    ...
    def test_gap_urgency_with_new_constructs(self):
        ...
        assert urgency > 0.5  # high urgency (numerical gradient × confidence)
